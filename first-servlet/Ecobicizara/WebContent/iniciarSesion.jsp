        ...
        <header class="header_area">
            ...
            <div class="zoneLink">
				...
				<table id="tablaCabecera">
					<tr>	
						<td>
							<a 	class="inicioSesion" href="iniciarSesion.html" ><img  class="iconoInicio1" src="imagenes/inicioSesion.png" alt=""></a>
						</td>
						<td>
						...
						<td>
							<form class="cerrarSesion" action="" method="post">
								<input size="2px" class="campo" type="submit" value="Cerrar SesiÃ³n"/>
							</form>
						</td>
					</tr>
				</table>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item" ><center><a class="nav-link" href="registrarse.html">Registrarse</a></center></li>
                        </ul>
                    </div> 
                </div>
            </nav>
        ...
        <section class="breadcrumb_area br_image">
            <div class="container">
                <div class="page-cover text-center">
                    <h2 class="page-cover-tittle">Iniciar SesiÃ³n</h2>
                    <!--<ol class="breadcrumb">
                ...
                <!--<div class="sermons_slider owl-carousel">-->
					<form id="iniciarse" action="iniciarse" method="post">
						<table class="iniciarS">
							<tr>
								<td class="tablaC"><label for="nick"><b class="inicio1">Nombre de usuario:</b></label></td>
							</tr>
							<tr>
								<td class="tablaC">
									<input class="campo" type="text" name="name" value=""/>
									<p> Inserte aqui su error </p>
								</td>
							</tr>
							<tr>
								<td class="tablaC"><label for="password"><b class="inicio1">ContraseÃ±a:</b></label></td>
							</tr>
							<tr>
								<td class="tablaC"><input class="campo" type="password" name="password" value=""/></td>
							</tr>
							<tr>
								<td class="tablaC"><input class="campo" type="submit" value="Iniciar SesiÃ³n"/></td>
							</tr>
						</table>	
					</form>
            </div>
