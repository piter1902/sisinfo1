 ...
 * Generated at: 2019-12-01 11:08:26 UTC
...
public final class registrarse_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t</center>\r\n");
      out.write("\t\t\t\t<div class=\"camposReg\">\r\n");
      out.write("\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t<label class=\"camposNewReg1\" for=\"NickName\">NickName:</label> <input\r\n");
      out.write("\t\t\t\t\t\t\tclass=\"camposNewReg2\" type=\"text\" name=\"nickname\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"");
      out.print(nickValor);
      out.write("\" id=\"idNick\" />");
      out.print(nickError);
      ...
      out.write("\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t<label class=\"camposNewReg1\" for=\"name\">Nombre:</label> <input\r\n");
      out.write("\t\t\t\t\t\t\tclass=\"camposNewReg2\" type=\"text\" name=\"nombre\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"");
      out.print(nombValor);
      ...
      out.write("\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t<label class=\"camposNewReg1\" for=\"apellidos\">Apellidos:</label> <input\r\n");
      out.write("\t\t\t\t\t\t\tclass=\"camposNewReg2\" type=\"text\" name=\"apellidos\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"");
      out.print(apeValor);
      ...
      out.write("\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t<label class=\"camposNewReg1\" for=\"password\">Contraseña:</label> <input\r\n");
      out.write("\t\t\t\t\t\t\tclass=\"camposNewReg2\" type=\"password\" name=\"password\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"");
      out.print(passValor);
      ...
      out.write("\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t<label class=\"camposNewReg1\" for=\"password1\">Repetir\r\n");
      out.write("\t\t\t\t\t\t\tContraseña:</label> <input class=\"camposNewReg2\" type=\"password\"\r\n");
      out.write("\t\t\t\t\t\t\tname=\"password1\" value=\"");
      ...
      out.write("\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t<label class=\"camposNewReg1\" for=\"email\">Dirección de\r\n");
      out.write("\t\t\t\t\t\t\tCorreo:</label> <input class=\"camposNewReg2\" type=\"text\" name=\"email\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"");
      ...
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td><label for=\"tipo_vehiculo\"> <select\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"listaRegistro\" name=\"tipo_vehiculo\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(tipoVehicValor);
      out.write("\" id=\"idVehiculo\" />");
      out.print(tipoVehicError);
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"mal\" selected>Elige un tipo de vehiculo</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"Moto\">Moto</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"Coche\">Coche</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"Bus\">Bus</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"Camión\">Camión</option> </select>\r\n");
      out.write("\t\t\t\t\t\t\t</label></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><label for=\"combustible\"> <select\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"listaRegistro\" name=\"combustible\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(combustValor);
      out.write("\" id=\"idCombust\" />");
      out.print(combustError);
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"mal\" selected>Elige un tipo de\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tcombustible</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"gasolina\">Gasolina</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"diesel\">Diesel</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"hibrido\">Hibrido</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"lpg_bifuel\">lpg bifuel</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"lpg_biguel_petrol\">lpg_biguel_petrol</option> </select>\r\n");
      out.write("\t\t\t\t\t\t\t</label></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th>Contaminante</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th>Motor</th>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td><label for=\"contaminante\"> <select\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"listaRegistro\" name=\"contaminante\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(contamValor);
      out.write("\" id=\"idContam\" />");
      out.print(contamError);
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"mal\" selected>Elige el contaminante</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"desconocido\">Desconocido</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"co\">co</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"nox\">nox</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"0\">0</option> </select>\r\n");
      out.write("\t\t\t\t\t\t\t</label></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><label for=\"motor\"> <select\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"listaRegistro\" name=\"motor\" value=\"");
      out.print(motorValor);
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"idMotor\" />");
      out.print(motorError);
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"mal\" selected>Elige el motor</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"desconocido\">Desconocido</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"gdi\">gdi</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"pfi\">pfi</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"gdi+gpf\">gdi+gpf</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"dpf\">dpf</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"dpf+src\">dpf+src</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"lnt+dpf\">lnt+dpf</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"src\">src</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"egr\">egr</option> </select>\r\n");
      out.write("\t\t\t\t\t\t\t</label></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t<br> <br> <br>\r\n");
      out.write("\t\t\t\t\t<div class=\"botonesRegistro\">\r\n");
      out.write("\t\t\t\t\t\t<input class=\"entrada1_1\" type=\"submit\" value=\"Registrase\" />\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</section>\r\n");
