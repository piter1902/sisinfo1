    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active" ><center><a class="nav-link" href="contact.jsp">Contact</a></center></li>
        ...
        <section class="event_date_area">
			<div id="mapacontact"></div>
				<script>
					var mymap = L.map('mapacontact').setView([41.683149, -0.887533], 17);
                ...
                <div class="col-md-3">
                    <div class="contact_info">
                        <div class="info_item">
                            ...
                            <p>Universidad de Zaragoza: Escuela de Ingeniería y Arquitectura, Edificio Ada Byron</p>
                        </div>
                        <div class="info_item">
                            <i class="lnr lnr-phone-handset"></i>
                            <h6><a href="#">656293327</a></h6>
                            <p>Lunes a Viernes 8am - 19pm</p>
                        </div>
                        <div class="info_item">
                            <i class="lnr lnr-envelope"></i>
                            <h6><a href="#">ecobicizara@gmail.com</a></h6>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <textarea class="form-control" name="message" id="message" rows="1"
                                    placeholder="Escribe mensaje"></textarea>
                            </div>
                        </div>
                        <div class="col-md-12 text-right">
                            <button type="submit" value="submit" class="btn btn_hover btn_hover_two">Enviar mensaje</button>
                        </div>
                    </form>
                </div>
            </div>
