    ...
    <body>
        ...
        <section class="breadcrumb_area br_image">
            <div class="container">
                <div class="page-cover text-center">
                    <h2 class="page-cover-tittle">Cambiar datos personales</h2>
                    <!--<ol class="breadcrumb">
        ...
        <section class="sermons_work_area section_gap">
            <div class="container">
				...
				<div id="moverse1">
						<form id="NuevoNick" style="margin:auto" action="modificarUser" method="post">
										<div class="antesVehic">
											<p>
												<label class="camposOldReg1" for="nick">Nick:</label>
												<input class="camposOldReg2" readonly type="text" name="nick" value="" />
											</p>
											<p>
												<label class="camposOldReg1" for="name">Nombre:</label> 
												<input class="camposOldReg2" readonly type="text" name="nombre" value="" />
											</p>
											<p>
												<label class="camposOldReg1" for="apellidos">Apellidos:</label> 
												<input class="camposOldReg2" readonly type="text" name="apellidos" value="" />
											</p>
											<p>
												<label class="camposOldReg1" for="email">Dirección de Correo:</label>
												<input class="camposOldReg2" readonly type="text" name="email" value="" />
											</p>
											<p>
												<label class="camposOldReg1" for="password">Contraseña anterior:</label> 
												<input class="camposOldReg2"  type="password" readonly name="password" value="" />
											</p>
											<p>
												<label class="camposOldReg1" for="vehiculoA">Vehiculo actual:</label> 
												<input class="camposOldReg2" readonly type="text" name="vehiculoA" value="" />
											</p>
											<p>
												<label class="camposOldReg1" for="motorA">Motor actual:</label>
												<input class="camposOldReg2" readonly type="text" name="motorA" value="" />
											</p>
											<p>
												<label class="camposOldReg1" for="combustibleA">Combustible actual</label> 
												<input class="camposOldReg2" type="text" readonly name="combustibleA" value="" />
											</p>
										</div>
										<div class="despuesVehic">
											<p>
												<label class="camposOldReg3" for="name">Cambiar Nick:</label> 
												<input class="camposOldReg4" type="text" name="newnickname" value="" id="idNickname" /><br>
											</p>
											<p>				
												<label class="camposOldReg3" for="name">Cambiar Nombre:</label> 
												<input class="camposOldReg4" type="text" name="newnombre" value="" />
											</p>
											<p>									
												<label class="camposOldReg3" for="appellidos">Cambiar Apellidos:</label> 
												<input class="camposOldReg4" type="text" name="newapellidos" value="" />
											</p>
											<p>
												<label class="camposOldReg3" for="email">Cambiar Dirección de Correo:</label> 
												<input class="camposOldReg4" type="text" name="newemail" value="" id="idEmail" /><br>
											</p>
											<p>
												<label class="camposOldReg3" for="password">Contraseña:</label> 
												<input class="camposOldReg4" type="password" name="newpassword" value="" />
											</p>
											<p>
												<label class="camposOldReg3" for="password1">Repetir Contraseña:</label>
												<input class="camposOldReg4" type="password" name="newpassword1" value="" id="idPassword" />
											</p>
										</div>
									<p>
										<div class="tablaReg">
								...
								<div class="reiniciodP">	
									<input type="reset" value="Cancelar" /> <input type="submit" value="Modificar Usuario" /> <br>
								</div>
					</form>
					<form id="DarseDeBaja" action="eliminarUser" method="post" style="text-align: center">
						<center>
							<h3>Darse de baja en el servicio</h3>
						</center>
						<p>Si está seguro, marque la casilla "Si":</p>
						<input type="radio" name="decision" value="si" />Si<br> 
						<input type="reset" value="Cancelar" /> <input type="submit" value="Darse de baja" />
					</form>
			</div>
        </section>
        <!--================Sermons work Area=================-->
